...
public class BillableTaskHighchartGadget extends HighchartGadget {
	...
	public String generate(Vector selectedFields)  throws BusinessException {
        ...
        try {
            ...
            if (pto!=null) {
        		...
        		//draw the bars
                response = super.getHeader(this.getId(), "column", "Billable X Non-Billable", pto.getName(), false) +
                		   super.getLegend(false) +
                		   super.getXAxis(xaxis, false) +
                		   super.getYAxis(0, "(h)") +
                		   super.getTooltip() +
                		   super.getPlot(labels, billVals, true, null) +
                		   super.getFooter();
            }
