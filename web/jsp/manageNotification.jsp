...
<html:form action="manageNotification">
    ...
    <tr class="pagingFormBody">
      ...
      <td class="formBody">
		<html:select name="notificationForm" property="periodicity" styleClass="textBox">
			<html:options collection="periodicityList" property="id" labelProperty="genericTag"/>
		</html:select>              
      </td>
		...
		<table width="98%" border="0" cellspacing="0" cellpadding="0"><tr>
		  <td width="120">
			  <html:button property="save" styleClass="button" onclick="javascript:buttonClick('notificationForm', 'saveNotification');">
				<bean:write name="notificationForm" property="saveLabel" />
			  </html:button>    
		  </td>
		  <td width="120">
	...
	<tr class="formBody">
		<td>
			<display:table border="1" width="100%" name="notificationList" scope="session" pagesize="6">
				  <display:column width="15%" property="name" likeSearching="true" title="label.name" />
				  <display:column property="description" likeSearching="true" title="label.formNotification.description" />
				  <display:column width="15%" property="nextNotification" align="center" title="label.formNotification.nextNotific" decorator="com.pandora.gui.taglib.decorator.GridDateDecorator" tag="2;2" />	
				  <display:column width="15%" property="finalDate" align="center" title="label.formNotification.disabledDate" decorator="com.pandora.gui.taglib.decorator.GridDateDecorator" tag="2;2" />					  
				  <display:column width="2%" property="id" title="grid.title.empty" decorator="com.pandora.gui.taglib.decorator.GridEditDecorator" tag="'notificationForm', 'editNotification'" />
				  <display:column width="2%" property="id" title="grid.title.empty" decorator="com.pandora.gui.taglib.decorator.GridDeleteDecorator" tag="'notificationForm', 'removeNotification'" />
			</display:table>		
		</td>
	</tr> 
	</table>
