...
public class ResourceCategoryAllocHighchartGadget extends HighchartGadget {
        	...
        	if (resourceId!=null && intervType!=null && !resourceId.equals("-1")) {
                ...
                if (pto!=null) {                	
                    ...
                    if (dbAllocList!=null) {
                    	for (int i=1; i<dbAllocList.size(); i++) {
                            ...
                            if (index>-1) {
                                ...
                                if (idx==null) {
                                	...
                                	idx = newValue;
                                	if (catName.equals("&nbsp;")) {
                                		labels[idx.intValue()] = super.getI18nMsg("label.manageOption.gadget.rescatcap.nocat");
                                	} else {
                		...
                		//draw the chart
                        response = super.getHeader(this.getId(), "column", super.getI18nMsg(getUniqueName()), pto.getName(), false) +
