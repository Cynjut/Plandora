...
<html:form  action="manageMetaField">
    ...
    <tr class="pagingFormBody">
      <td width="10">&nbsp;</td>
      <td width="150" class="formTitle"><bean:message key="label.formMetaField.name"/>:&nbsp;</td>
    ...
    <tr class="pagingFormBody">
      ...
      <td class="formBody">
	  	<html:select name="metaFieldForm" property="applyTo" styleClass="textBox" onkeypress="javascript:changeApplyCombo();" onchange="javascript:changeApplyCombo();">
			<html:options collection="applyToList" property="id" labelProperty="genericTag"/>
		</html:select>
      </td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>      
		...
		<table width="98%" border="0" cellspacing="0" cellpadding="0"><tr>
		  <td width="120">
			  <html:button property="save" styleClass="button" onclick="javascript:buttonClick('metaFieldForm', 'saveMetaField');">
				<bean:write name="metaFieldForm" property="saveLabel" />
			  </html:button>    
		  </td>
		  <td width="120">
	...
	<tr class="formBody">
		<td>
			<display:table border="1" width="100%" name="metaFieldList" scope="session" pagesize="8">
				  <display:column property="name" likeSearching="true" title="label.name" />
				  <display:column width="20%" align="center" property="type" title="label.formMetaField.type" decorator="com.pandora.gui.taglib.decorator.GridMetaFieldDecorator" tag="1"/>
				  <display:column width="20%" align="center" property="applyTo" title="label.formMetaField.applyTo" decorator="com.pandora.gui.taglib.decorator.GridMetaFieldDecorator" tag="2" />
				  <display:column width="20%" likeSearching="true" align="center" comboFilter="true" property="project.name" title="label.formMetaField.project" />
				  <display:column width="15%" property="disableDate" align="center" title="label.formMetaField.disabledDate" decorator="com.pandora.gui.taglib.decorator.GridDateDecorator" tag="2;2" />
				  <display:column width="2%" property="id" title="grid.title.empty" decorator="com.pandora.gui.taglib.decorator.GridEditDecorator" tag="'metaFieldForm', 'editMetaField'" />
				  <display:column width="2%" property="id" title="grid.title.empty" decorator="com.pandora.gui.taglib.decorator.GridDeleteDecorator" tag="'metaFieldForm', 'removeMetaField'" />
			</display:table>		
		</td>
	</tr> 
	</table>
