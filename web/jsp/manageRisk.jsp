...
<html:form action="manageRisk">
    ...
    <tr class="pagingFormBody">
      ...
      <td width="400" class="formBody">
        <bean:write name="riskForm" property="projectName" />
      </td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr class="pagingFormBody">
      ...
      <td width="180" class="formBody">
	  		<html:select name="riskForm" property="probability" styleClass="textBox">
	             <html:options collection="probabilityList" property="id" labelProperty="genericTag"/>
			</html:select>
      </td>
      ...
      <td width="100" class="formBody">
	  		<html:select name="riskForm" property="impact" styleClass="textBox">
	             <html:options collection="impactList" property="id" labelProperty="genericTag"/>
			</html:select>
      </td>
      ...
      <td class="formBody">
	  		<html:select name="riskForm" property="tendency" styleClass="textBox">
	             <html:options collection="tendencyList" property="id" labelProperty="genericTag"/>
			</html:select>
      </td>
      <td width="10" >&nbsp;</td>
    </tr>
    ...
    <tr class="pagingFormBody">
      ...
      <td class="formBody">
	  		<html:select name="riskForm" property="status" styleClass="textBox">
	             <html:options collection="riskStatusList" property="id" labelProperty="name"/>
			</html:select>
      </td>
      <td>&nbsp;</td>
    </tr>
	...
	<display:headerfootergrid type="FOOTER">			
		<table width="98%" border="0" cellspacing="0" cellpadding="0"><tr>
		  <td width="120">
			  <html:button property="save" styleClass="button" onclick="javascript:buttonClick('riskForm', 'saveRisk');">
				<bean:write name="riskForm" property="saveLabel" />
			  </html:button>    
		  </td>
		  <td width="120">
	...
	<tr class="formBody">
		<td>
			<display:table border="1" width="100%" name="riskList" scope="session" pagesize="6" requestURI="../do/manageRisk?operation=navigate">
				  ...
				  <display:column sort="true" property="name" likeSearching="true" title="label.formRisk.name" />
				  <display:column sort="true" width="15%" align="center" property="project.name" title="label.formRisk.project" description="label.formRisk.project.desc" visibleProperty="<%=PreferenceTO.RSK_SW_PROJECT%>" />
				  <display:column sort="true" width="10%" align="center" property="riskType" title="label.formRisk.type" description="label.formRisk.type" visibleProperty="<%=PreferenceTO.RSK_SW_TYPE%>" tag="TYPE" decorator="com.pandora.gui.taglib.decorator.RiskHistoryGridStatusDecorator" />				  
				  <display:column sort="true" width="10%" align="center" property="status.name" title="label.formRisk.status" description="label.formRisk.status.desc" visibleProperty="<%=PreferenceTO.RSK_SW_STATUS%>" />
				  <display:column sort="true" width="5%" align="center" property="probability" title="label.formRisk.probability" description="label.formRisk.probability" visibleProperty="<%=PreferenceTO.RSK_SW_PROB%>" tag="PROB" decorator="com.pandora.gui.taglib.decorator.RiskHistoryGridStatusDecorator" />
				  <display:column sort="true" width="5%" align="center" property="impact" title="label.formRisk.impact" description="label.formRisk.impact" visibleProperty="<%=PreferenceTO.RSK_SW_IMPACT%>" tag="IMPA" decorator="com.pandora.gui.taglib.decorator.RiskHistoryGridStatusDecorator" />
				  <display:column sort="true" width="5%" align="center" property="tendency" title="label.formRisk.tendency" description="label.formRisk.tendency" visibleProperty="<%=PreferenceTO.RSK_SW_TENDENCY%>" tag="TEND" decorator="com.pandora.gui.taglib.decorator.RiskHistoryGridStatusDecorator" />
				  <display:column width="5%" align="center" property="costImpact" title="label.formRisk.impact.cost" description="label.formRisk.impact.cost" visibleProperty="<%=PreferenceTO.RSK_SW_IMP_COST%>" tag="I_COST" decorator="com.pandora.gui.taglib.decorator.RiskHistoryGridStatusDecorator" />
				  <display:column width="5%" align="center" property="qualityImpact" title="label.formRisk.impact.qual" description="label.formRisk.impact.qual" visibleProperty="<%=PreferenceTO.RSK_SW_IMP_QUAL%>" tag="I_QUAL" decorator="com.pandora.gui.taglib.decorator.RiskHistoryGridStatusDecorator" />
				  <display:column width="5%" align="center" property="scopeImpact" title="label.formRisk.impact.scop" description="label.formRisk.impact.scop" visibleProperty="<%=PreferenceTO.RSK_SW_IMP_SCOP%>" tag="I_SCOP" decorator="com.pandora.gui.taglib.decorator.RiskHistoryGridStatusDecorator" />
				  <display:column width="5%" align="center" property="timeImpact" title="label.formRisk.impact.time" description="label.formRisk.impact.time" visibleProperty="<%=PreferenceTO.RSK_SW_IMP_TIME%>" tag="I_TIME" decorator="com.pandora.gui.taglib.decorator.RiskHistoryGridStatusDecorator" />
				  <display:column sort="true" width="15%" align="center" property="category.name" comboFilter="true" likeSearching="true" title="label.formRisk.category" description="label.formRisk.category" visibleProperty="<%=PreferenceTO.RSK_SW_CATEGORY%>" />
				  <display:column sort="true" width="20%" align="center" property="responsible" likeSearching="true" title="label.formRisk.responsible" description="label.formRisk.responsible" visibleProperty="<%=PreferenceTO.RSK_SW_RESPONSIBLE%>" />				  
				  <display:column width="2%" property="id" title="grid.title.empty" decorator="com.pandora.gui.taglib.decorator.GridEditDecorator" tag="'riskForm', 'editRisk'" />
				  <display:column width="2%" property="id" title="grid.title.empty" decorator="com.pandora.gui.taglib.decorator.GridDeleteDecorator" tag="'riskForm', 'removeRisk'" />
				  <display:column width="2%" property="id" title="grid.title.empty" decorator="com.pandora.gui.taglib.decorator.GridDetailDecorator" tag="'RSK'" />				  
			</display:table>		
		</td>
	</tr> 
	</table>
...
<script> 
	with(document.forms["riskForm"]){	
		name.focus(); 
		if (showIssueConfirmation.value=='on') {
